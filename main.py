...
for items in info_list[1:]:
  if 'доб' in items[5]:
    pattern_d = r'(\+7|8)(\s*|\()(\(|s*)(495)(-|\)|s*)\s*(\d{3})(-|s*)(\d{2})(-|s*)(\d{2})(\s*|)(\(|\s*)(\доб.|)\s*(\d+|)(\)|)'
    res = re.sub(pattern_d, r"+7(\4)\6-\8-\10 \13 \14", items[5])
    items[5] = res
  else:
    pattern = r'(\+7|8)(\s*|\()(\(|s*)(495)(-|\)|s*)\s*(\d{3})(-|s*)(\d{2})(-|s*)(\d{2})'
    res = re.sub(pattern, r"+7(\4)\6-\8-\10", items[5])
    items[5] = res
